...
export declare type MessageQuery = components['schemas']['MessageQuery'];
...
export declare type Report = components['schemas']['Report'];
...
export declare type DataEditReport = components['schemas']['DataEditReport'];
export declare type ReportStatus = components['schemas']['ReportStatus'];
export declare type ReportStatusString = components['schemas']['ReportStatusString'];
export declare type DataReportContent = components['schemas']['DataReportContent'];
export declare type SnapshotWithContext = components['schemas']['SnapshotWithContext'];
export declare type SnapshotContent = components['schemas']['SnapshotContent'];
export declare type AccountStrike = components['schemas']['AccountStrike'];
export declare type DataCreateStrike = components['schemas']['DataCreateStrike'];
export declare type DataEditAccountStrike = components['schemas']['DataEditAccountStrike'];
