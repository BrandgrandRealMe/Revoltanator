 ...
 */
export declare const id_pkcs9_mo: string;
/**
 * pkcs-9-oc OBJECT IDENTIFIER ::= {pkcs-9 24} -- Object class branch
 */
export declare const id_pkcs9_oc: string;
/**
 * pkcs-9-at OBJECT IDENTIFIER ::= {pkcs-9 25} -- Attribute branch, for
 *                                             -- new  attributes
 */
export declare const id_pkcs9_at: string;
/**
 * pkcs-9-sx OBJECT IDENTIFIER ::= {pkcs-9 26} -- For syntaxes (RFC 2252)
 */
export declare const id_pkcs9_sx: string;
/**
 * pkcs-9-mr OBJECT IDENTIFIER ::= {pkcs-9 27} -- Matching rules
 */
export declare const id_pkcs9_mr: string;
/**
 * pkcs-9-oc-pkcsEntity    OBJECT IDENTIFIER ::= {pkcs-9-oc 1}
 */
export declare const id_pkcs9_oc_pkcsEntity: string;
/**
 * pkcs-9-oc-naturalPerson OBJECT IDENTIFIER ::= {pkcs-9-oc 2}
 */
export declare const id_pkcs9_oc_naturalPerson: string;
/**
 * pkcs-9-at-emailAddress        OBJECT IDENTIFIER ::= {pkcs-9 1}
 */
export declare const id_pkcs9_at_emailAddress: string;
/**
 * pkcs-9-at-unstructuredName    OBJECT IDENTIFIER ::= {pkcs-9 2}
 */
export declare const id_pkcs9_at_unstructuredName: string;
/**
 * pkcs-9-at-contentType         OBJECT IDENTIFIER ::= {pkcs-9 3}
 */
export declare const id_pkcs9_at_contentType: string;
/**
 * pkcs-9-at-messageDigest       OBJECT IDENTIFIER ::= {pkcs-9 4}
 */
export declare const id_pkcs9_at_messageDigest: string;
/**
 * pkcs-9-at-signingTime         OBJECT IDENTIFIER ::= {pkcs-9 5}
 */
export declare const id_pkcs9_at_signingTime: string;
/**
 * pkcs-9-at-counterSignature    OBJECT IDENTIFIER ::= {pkcs-9 6}
 */
export declare const id_pkcs9_at_counterSignature: string;
/**
 * pkcs-9-at-challengePassword   OBJECT IDENTIFIER ::= {pkcs-9 7}
 */
export declare const id_pkcs9_at_challengePassword: string;
/**
 * pkcs-9-at-unstructuredAddress OBJECT IDENTIFIER ::= {pkcs-9 8}
 */
export declare const id_pkcs9_at_unstructuredAddress: string;
/**
 * pkcs-9-at-extendedCertificateAttributes
 *                               OBJECT IDENTIFIER ::= {pkcs-9 9}
 */
export declare const id_pkcs9_at_extendedCertificateAttributes: string;
/**
 ...
 */
export declare const id_pkcs9_at_signingDescription: string;
/**
 * pkcs-9-at-extensionRequest         OBJECT IDENTIFIER ::= {pkcs-9 14}
 */
export declare const id_pkcs9_at_extensionRequest: string;
/**
 * pkcs-9-at-smimeCapabilities        OBJECT IDENTIFIER ::= {pkcs-9 15}
 */
export declare const id_pkcs9_at_smimeCapabilities: string;
/**
 * -- Unused (?)
 ...
 */
export declare const id_pkcs9_at_friendlyName: string;
/**
 * pkcs-9-at-localKeyId               OBJECT IDENTIFIER ::= {pkcs-9 21}
 */
export declare const id_pkcs9_at_localKeyId: string;
/**
 ...
 */
export declare const id_pkcs9_at_pkcs15Token: string;
/**
 * pkcs-9-at-encryptedPrivateKeyInfo  OBJECT IDENTIFIER ::= {pkcs-9-at 2}
 */
export declare const id_pkcs9_at_encryptedPrivateKeyInfo: string;
/**
 * pkcs-9-at-randomNonce              OBJECT IDENTIFIER ::= {pkcs-9-at 3}
 */
export declare const id_pkcs9_at_randomNonce: string;
/**
 * pkcs-9-at-sequenceNumber           OBJECT IDENTIFIER ::= {pkcs-9-at 4}
 */
export declare const id_pkcs9_at_sequenceNumber: string;
/**
 * pkcs-9-at-pkcs7PDU                 OBJECT IDENTIFIER ::= {pkcs-9-at 5}
 */
export declare const id_pkcs9_at_pkcs7PDU: string;
/**
 ...
 */
export declare const id_pkcs9_at_dateOfBirth: string;
/**
 * pkcs-9-at-placeOfBirth             OBJECT IDENTIFIER ::= {ietf-at 2}
 */
export declare const id_pkcs9_at_placeOfBirth: string;
/**
 * pkcs-9-at-gender                   OBJECT IDENTIFIER ::= {ietf-at 3}
 */
export declare const id_pkcs9_at_gender: string;
/**
 * pkcs-9-at-countryOfCitizenship     OBJECT IDENTIFIER ::= {ietf-at 4}
 */
export declare const id_pkcs9_at_countryOfCitizenship: string;
/**
 * pkcs-9-at-countryOfResidence       OBJECT IDENTIFIER ::= {ietf-at 5}
 */
export declare const id_pkcs9_at_countryOfResidence: string;
/**
 * pkcs-9-sx-pkcs9String              OBJECT IDENTIFIER ::= {pkcs-9-sx 1}
 */
export declare const id_pkcs9_sx_pkcs9String: string;
/**
 * pkcs-9-sx-signingTime              OBJECT IDENTIFIER ::= {pkcs-9-sx 2}
 */
export declare const id_pkcs9_sx_signingTime: string;
/**
 * pkcs-9-mr-caseIgnoreMatch          OBJECT IDENTIFIER ::= {pkcs-9-mr 1}
 */
export declare const id_pkcs9_mr_caseIgnoreMatch: string;
/**
 * pkcs-9-mr-signingTimeMatch         OBJECT IDENTIFIER ::= {pkcs-9-mr 2}
 */
export declare const id_pkcs9_mr_signingTimeMatch: string;
/**
 ...
 */
export declare const id_smime: string;
/**
 ...
 */
export declare const crlTypes: string;
/**
 ...
 */
export declare const id_at_pseudonym: string;
/**
 * -- Useful types
 */
/**
...
export declare type GenderType = "M" | "F" | "m" | "f";
/**
 * gender ATTRIBUTE ::= {
