...
exports.MinecraftServerInfo = void 0;
...
class MinecraftServerInfo {
    ...
    serverInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            const obj = (yield axios_1.default.get(`${this.mcapiBaseURL}status?ip=${this.serverIp}&port=${this.port}`)).data;
            const objWithStripped = Object.assign(Object.assign({}, obj), { motd_stripped: (0, common_tags_1.stripIndents)(obj.motd) });
    ...
    query() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const obj = (yield axios_1.default.get(`${this.minetoolsBaseURL}query/${this.serverIp}/${this.queryPort}`)).data;
...
exports.MinecraftServerInfo = MinecraftServerInfo;
